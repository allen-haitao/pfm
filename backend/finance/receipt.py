...
class Product(BaseModel):
    ...
    category: str = Field(description="the category of the product based on its description")
...
class TotalBill(BaseModel):
    ...
    category_subtotals: Dict[str, float] = Field(description="subtotals for each category")  # New field for category subtotals
    ...
    messages = [
        {
            ...
            "content": [
                ...
                'Food', 'Utilities', 'Fuel', 'Clothing', 'Entertainment','Beauty Products','Insurance','Education','Gifts','Miscellaneous'."
                },
            ],
        }
    ]
